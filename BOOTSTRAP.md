...
* par valeur : nom (lien vers sa fiche Yahoo Finance), ticker, **dernière clôture en premier** avec sa date, variation du jour, **écart vs prévisionnel J-1** = variation de la valeur − milieu de l'intervalle 80 % prévu la veille pour l'indice, sparkline ~45 séances, et historique déroulant **antichronologique** (date, clôture, variation, écart par séance) ;
